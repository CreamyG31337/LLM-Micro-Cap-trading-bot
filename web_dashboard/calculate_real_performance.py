...
def get_real_performance_data():
    ...
    headers = {
        "apikey": "sb_publishable_R_b-froDVtQajU1omB0bRA_g3A6YsLU",
        "Authorization": "Bearer sb_publishable_R_b-froDVtQajU1omB0bRA_g3A6YsLU",
...
def update_performance_metrics(performance_data):
    ...
    headers = {
        "apikey": "sb_secret_KQFK8qlt3mj5jIHCOQTsng_jRoIpAk_",
        "Authorization": "Bearer sb_secret_KQFK8qlt3mj5jIHCOQTsng_jRoIpAk_",
        "Content-Type": "application/json"
    }
