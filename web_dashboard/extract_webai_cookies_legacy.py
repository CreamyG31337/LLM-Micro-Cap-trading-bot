#!/usr/bin/env python3
"""
Extract Gemini Cookies from Browser
====================================

Helps extract cookies from your browser to use with Gemini's web interface.
...
Usage:
    python web_dashboard/extract_gemini_cookies.py [--browser chrome|firefox|edge] [--output cookies.json]
"""
...
def extract_chrome_cookies(domain: str = "gemini.google.com") -> List[Dict[str, Any]]:
    """
...
def extract_firefox_cookies(domain: str = "gemini.google.com") -> List[Dict[str, Any]]:
    """
...
def manual_extraction_instructions():
    ...
    print("=" * 60)
    print("\n1. Open your browser and navigate to: https://gemini.google.com")
    print("2. Make sure you're logged in with your Google AI Pro account")
    ...
    print("6. Click on 'https://gemini.google.com'")
    ...
    print("   - Any other cookies with 'gemini' or 'google' in the name")
    ...
    print("   }")
    print("\n9. Save it as 'gemini_cookies.json'")
    print("\n" + "=" * 60)


def main():
    parser = argparse.ArgumentParser(description="Extract cookies from browser for Gemini")
    parser.add_argument(
        "--browser",
    ...
    parser.add_argument(
        "--output",
        default="gemini_cookies.json",
        help="Output file for cookies (default: gemini_cookies.json, saved to project root)"
    )
    parser.add_argument(
        "--domain",
        default="gemini.google.com",
        help="Domain to extract cookies for (default: gemini.google.com)"
    )
    ...
    print(f"  You can now use them with: python web_dashboard/gemini_cookie_client.py --cookies {output_path} --query 'Your question'")
