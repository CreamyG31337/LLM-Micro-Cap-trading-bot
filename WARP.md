...
- Always use `test_data/` directory for development (not `my trading/` which is production)
...
1. **Data Safety**: Always use `test_data/` directory during development to avoid affecting production data in `my trading/`
...
- **Production Data**: `my trading/` (gitignored)
- **Test Data**: `test_data/` (use for development)
